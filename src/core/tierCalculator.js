...
window.BOJ_CF.TierCalculator = (function() {
    return {
        getUserTierIcon: (rating) => {
            ...
            if (r < 1200) return 'icons/bronze1.svg'; // 예시 하드코딩
            if (r < 1400) return 'icons/silver3.svg';
            if (r < 1600) return 'icons/gold3.svg';
            if (r < 1900) return 'icons/platinum3.svg';
            if (r < 2100) return 'icons/diamond3.svg';
            if (r < 2400) return 'icons/ruby3.svg';
